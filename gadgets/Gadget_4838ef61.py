        ...
        try:
            ...
            for i in range(1, input_data + 1):
                ...
                for j in range(1, i + 1):
                    ...
                    logger.debug(
                        f"Inner loop i={i}, j={j}, transformation={transformation}, inner_sum={inner_sum}"
                    )
                ...
                logger.info(
                    f"Outer loop i={i}, inner_sum={inner_sum}, irrelevant_transformation={irrelevant_transformation}, aggregate={aggregate}"
                )
