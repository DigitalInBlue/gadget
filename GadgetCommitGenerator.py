    ...
    response = openai.chat.completions.create(
        ...
        messages=[
            ...
            },
            {
                "role": "user", 
                "content": 
                    "Generate a pseudo-scientific commit message related to **advanced computing, cryptography, AI heuristics, chaotic data structures, emergent computation, or recursive meta-algorithms.**\n"
                    "\n"
